...
export const PageHome = () => {
    ...
    if (isConnected) {
        ...
        return (
            <Page>
                <div className="w-full flex flex-col justify-start items-start gap-4">
                    <div className="text-transparent text-8xl bg-clip-text bg-gradient-to-r from-purple-600 to-purple-300">
                        Connect wallet
                    </div>
                    <div className="text-7xl text-slate-100">
                        to access the
                    </div>
                    <div className="flex flex-row text-8xl text-slate-100 gap-6">
                        Hodl <div className="animate-bounce hover:animate-spin"> 🍆 </div> Contest
                    </div>
                </div>
            </Page>
        );
